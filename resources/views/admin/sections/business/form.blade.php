<div class="block rounded-lg bg-white shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface mb-10 container-xl md:container mx-auto">
    ...
    <div class="grid grid-cols-12 gap-4 p-6">
        <div class="col-span-12 md:col-span-5">
            <x-input-large :value="old('name', $business->name ?? null)" id="input_name" name="name" type="text" class="mt-3 block w-full" placeholder="Nombre negocio" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('name')" />
        </div>
        <div class="col-span-12 md:col-span-3 mt-3">
            <select data-te-select-init data-te-select-size="lg" data-te-select-init data-te-select-filter="true"  id="select_user_id" name="user_id">
                {{ user_list( old('user_id', $user->id ?? null) ) }}
            </select>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="relative flex flex-wrap items-stretch mt-3">
                <span class="flex items-center whitespace-nowrap rounded-s border border-e-0 border-solid border-neutral-200 px-3 text-center text-base text-surface dark:border-white/10 dark:text-white bg-secondary-100">+56 9</span>
                <x-input-large :value="old('phone', $business->phone ?? null)"  id="input_phone" name="phone" type="text" maxlength="8" class="" placeholder="Teléfono" />
            </div>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="relative flex flex-wrap items-stretch mt-3">
                <span class="flex items-center whitespace-nowrap rounded-s border border-e-0 border-solid border-neutral-200 px-3 text-center text-base text-surface dark:border-white/10 dark:text-white bg-secondary-100">+56 9</span>
                <x-input-large :value="old('whatsapp', $business->whatsapp ?? null)"  id="input_whatsapp" name="whatsapp" type="text" maxlength="12" class="" placeholder="Whatsapp" />
            </div>
            <x-input-error class="mt-2" :messages="$errors->get('whatsapp')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('web', $business->web ?? null)" id="input_web" name="web" type="url" class="mt-3 block w-full" placeholder="Página web" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('web')" />
        </div>

        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('facebook', $business->facebook ?? null)" id="input_facebook" name="facebook" type="url" class="mt-3 block w-full" placeholder="Facebook" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('facebook')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('instagram', $business->instagram ?? null)" id="input_instagram" name="instagram" type="url" class="mt-3 block w-full" placeholder="Instagram" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('instagram')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('x', $business->x ?? null)" id="input_twitter" name="x" type="url" class="mt-3 block w-full" placeholder="X" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('x')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('tiktok', $business->tiktok ?? null)" id="input_tiktok" name="tiktok" type="url" class="mt-3 block w-full" placeholder="TikTok" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('tiktok')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('mercadolibre', $business->mercadolibre ?? null)" id="input_mercadolibre" name="facebook" type="url" class="mt-3 block w-full" placeholder="Mercado Libre" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('mercadolibre')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('yapo', $business->yapo ?? null)" id="input_Yapo" name="yapo" type="url" class="mt-3 block w-full" placeholder="Yapo" maxlength="255" required />
            <x-input-error class="mt-2" :messages="$errors->get('yapo')" />
        </div>
        <div class="col-span-12 md:col-span-4">
            <x-input-large :value="old('aliexpress', $business->aliexpress ?? null)" id="input_aliexpress" name="aliexpress" type="url" class="mt-3 block w-full" placeholder="Aliexpress" maxlength="255" required />
        ...
        <div class="col-span-12 md:col-span-3 mt-5 relative">
            ...
            <input type="hidden" value="{{ $business->id }}" name="folder" id="folder">
            ...
            @php
                $avatar = get_images_from_folder('business',$business->id,'avatar') ?? null;
                $avatar = ($avatar == 'default/_avatar.jpg') ? null : $avatar; 
            @endphp
            <img src="<?= asset('uploads/business/'.$avatar) ?>" alt="" class="mt-3" />

            <x-button id="delete_file" type="button" value="danger" class="mt-2 hidden" data-folder="{{ $business->id }}"><i class="fas fa-trash-alt"></i></x-button>
        ...
        <div class="col-span-12 md:col-span-9 mt-5 relative text">
            <p>Galeria del Negocio</p>
            @php
                $images = $business->id == 0 ? array() : get_images_from_folder('business',$business->id,'gallery');
            @endphp
            ...
            <div class="grid grid-cols-3 gap-4 mt-3">
                ...
                <div class="col-span-1">
                    <img src="<?= asset("uploads/business/".$i) ?>" alt="">

                    <x-button id="delete_file" type="button" value="danger" class="mt-2" data-type="business" data-file="{{ $i }}">
