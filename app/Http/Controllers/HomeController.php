...
class HomeController extends Controller
{
    public function index(){
        ...
        $data['business_comments'] = Comment::select('users.name as u_name', 'users.id as u_id', 'users.avatar as u_avatar', 'comments.id as comment_id','comments.body', 'comments.score', 'comments.created_at', 'business.name as b_name', 'business.score as b_score')
        ...
        $data['products_comments'] = Comment::select('users.name as u_name', 'users.id as u_id', 'users.avatar as u_avatar', 'comments.id as comment_id', 'comments.body', 'comments.score', 'comments.created_at', 'product.name as p_name', 'product.score as p_score')
                                    ->leftJoin('users', 'users.id', '=', 'comments.user_id')
