...
class TradesTable extends DataTableComponent
{
    protected $model = TradeSkill::class;
        ...
        return [
            ...
            ButtonGroupColumn::make('Acciones')
                ...
                ->buttons([
                    ...
                    ->title(fn($row) => 'Editar')
                    ->location(fn($row) => route('admin_trade.edit',['trade' => $row->id]) )
                    ...
                    ->title(fn($row) => 'Borrar')
                    ->location(fn($row) => route('admin_trade.destroy',['trade' => $row->id]) )
                    ->attributes(function($row){
                        return[
